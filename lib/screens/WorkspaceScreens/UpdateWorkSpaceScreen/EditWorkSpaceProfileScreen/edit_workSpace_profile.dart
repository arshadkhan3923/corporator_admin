...
class UpdateWorkSpaceScreen extends StatefulWidget {
 const UpdateWorkSpaceScreen({Key? key,
  }) : super(key: key);
  @override
  State<UpdateWorkSpaceScreen> createState() => _EditUserScreenState();
}
class _EditUserScreenState extends State<UpdateWorkSpaceScreen> {
            ...
            child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    _isListVisible == 1 ? const UpdateWorkSpaceInformation()
                        : _isListVisible == 2
                        ?
                    const WorkSpaceUserAccountSecurity()
                        : Container(),
                  ],
                )
            ),
