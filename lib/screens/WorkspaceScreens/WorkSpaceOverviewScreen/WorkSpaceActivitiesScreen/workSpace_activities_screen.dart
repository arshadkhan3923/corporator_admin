...
class WorkSpaceActivitiesScreen extends StatefulWidget {
  const WorkSpaceActivitiesScreen({Key? key}) : super(key: key);
  @override
  State<WorkSpaceActivitiesScreen> createState() => _DownloadActivitiesScreenState();
}
class _DownloadActivitiesScreenState extends State<WorkSpaceActivitiesScreen> {
