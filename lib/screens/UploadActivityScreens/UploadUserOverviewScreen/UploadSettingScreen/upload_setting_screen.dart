...
class UploadSettingScreen extends StatefulWidget {
  const UploadSettingScreen({Key? key}) : super(key: key);

  @override
  State<UploadSettingScreen> createState() => _UploadSettingScreenState();
}

class _UploadSettingScreenState extends State<UploadSettingScreen> {
