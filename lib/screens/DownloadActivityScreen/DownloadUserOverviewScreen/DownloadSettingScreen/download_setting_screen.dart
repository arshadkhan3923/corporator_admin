...
class DownloadSettingScreen extends StatefulWidget {
  const DownloadSettingScreen({Key? key}) : super(key: key);

  @override
  State<DownloadSettingScreen> createState() => _DownloadSettingScreenState();
}

class _DownloadSettingScreenState extends State<DownloadSettingScreen> {
