...
class RoleSettingScreen extends StatefulWidget {
  const RoleSettingScreen({Key? key}) : super(key: key);

  @override
  State<RoleSettingScreen> createState() => _RoleSettingScreenState();
}

class _RoleSettingScreenState extends State<RoleSettingScreen> {
