...
class AllDownloadsActivity extends StatelessWidget {
  const AllDownloadsActivity({Key? key}) : super(key: key);
  @override
          ...
          children: [
            ...
            StreamBuilder<List<AllRevenueModel>>(
              ...
              builder: (context, snapshot) {
                return Text(snapshot.data == null ?"0" :  snapshot.data![0].downloadActivity.toString(),
                  style: TextStyle(
                    color: Overseer.bgColors,
                    fontSize: 22.sp,
